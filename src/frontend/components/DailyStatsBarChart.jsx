...
import { DAY_ORDER } from '../config.jsx'
...
function DailyStatsBarChart({ items }) {
    ...
    const yMax = max(normalized, d => d.totalRides / d.days_count) ?? 0
            ...
            <div className="daily-chart-panel">
                <svg className="daily-chart-svg" viewBox={`0 0 ${width} ${height}`} role="img" aria-label="Bar chart of total rides by day of week">
                    ...
                    {normalized.map(d => {
                        ...
                        const y = yScale(d.totalRides / d.days_count)
                        ...
                        return (
                            <g key={d.day}>
                                ...
                                >
                                    ...
                                    {(d.totalRides / d.days_count).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                                </text>
                            </g>
                        )
                    })}
