...
function normalizeTripUsage(trip, maxTripCount) {
  return (Number(trip.hourly_rides) || 0) / maxTripCount
}
 ...
 * @param {Array} params.trips - Array of trip objects with sourcePosition, targetPosition, and hourly_rides
