...
Beyond simple cleaning, extracting new features is essential for uncovering meaningful insights. 
Transforming raw timestamps into categorical variables, calculating distance from coordinates  or computing advanced statistics 
allows us to capture patterns that aren't immediately visible in the original dataset.
